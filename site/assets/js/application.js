import DomAccessor from './main/dom/dom-accessor.js';
import HtmlElementFactory from './main/dom/html-element-factory.js';
import DisplayFactory from './main/engine/model/display/display-factory.js';
import Game from './main/engine/model/game/game.js';
class Application {
    static getInstance() {
